      ...
      <div class="k-cv-body">
        <div class="k-cv-col">
          ...
          <div class="k-cv-projects">
            <div class="k-cv-project" :style="{'--project-color': project.colors[0]}" v-for="(project,i) in projects" :key="i">
        ...
        <div class="k-cv-col">
          ...
          <div class="k-cv-fun">
            <v-chip small outlined color="#f3365c"><v-icon small>mdi-white-balance-sunny</v-icon> Japon</v-chip>
            <v-chip small outlined color="#428328"><v-icon small>mdi-car</v-icon> Automobile</v-chip>
            <v-chip small outlined color="#008DCB"><v-icon small>mdi-desktop-classic</v-icon> Technologies</v-chip>
          </div>
        </div>
      </div>
    </div>
        ...
        xps: [
          {
            ...
            description: 'Je découvre le monde du travail (DevOps + Support + Réseau)'
          },
          {
            name: 'Triskalia / Eureden',
            contrat: 'Alternance',
            job: 'Développeur Fullstack',
            description: 'Je fais principalement du développement métier, je pousse à la mise en place de VueJS (Front)'
          },
          {
